  ...
  <div class="container text-center">
    ...
    <div class="row py-5 justify-content-center">
      <div class="col-sm-6">
        ...
        <form action="/tasks" class="dashboard-form d-flex flex-column overview-card" method="POST">
          @csrf
          ...
          <textarea name="description" id="description" cols="30" rows="10" placeholder="Task Description"></textarea>
